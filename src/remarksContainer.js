    ...
    render() {
        return (
            <View style={styles.remarksContainer}>
                <RemarksMessagesContainer projid={this.state.projid} enable={this.props.enable} disable = {this.props.disable} type={this.state.type}/>
                <TextField_ButtonContainer projid={this.state.projid} enterMessage={(mess)=>this.enterMessage(mess)} type={this.state.type}/>
            </View>
...
const RemarksMessagesContainer = (props) => {
    return (<View style={styles.remarksMessagesContainer} >
        ...
        <MessagesSection projid={props.projid} enable={props.enable} disable = {props.disable}  type={props.type}/>
    </View>);
}
...
class MessagesSection extends Component {
    ...
    getChat = () => {
        var projid = this.props.projid;
            ...
            ios: "http://localhost/mp/getchat.php",
            android: "http://10.0.2.2/mp/getchat.php"
            });
            ...
            .then(function(response) {
                self.setState({mainData:response.data})
...
class TextField_ButtonContainer extends Component{
    ...
    loginButtonPressed = () => {
        ...
        const self = this;
            ...
            const url = Platform.select({
            ios: "http://localhost/mp/enterMessage.php",
            android: "http://10.0.2.2/mp/enterMessage.php"
            });
